...
var Order = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.OneToOne(function () { return Customer_1.default; }, { eager: true }),
        typeorm_1.JoinColumn({ name: 'customer_id' }),
        __metadata("design:type", Customer_1.default)
    ], Order.prototype, "customer", void 0);
    __decorate([
        typeorm_1.OneToMany(function () { return OrdersProducts_1.default; }, function (ordersProducts) { return ordersProducts.order; }, {
            eager: true,
            cascade: true,
        }),
